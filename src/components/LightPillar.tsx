...
const LightPillar: React.FC<LightPillarProps> = ({
    ...
    // Register this component as a loadable asset
    useEffect(() => {
        registerAsset("light-pillar-webgl");
    }, [registerAsset]);
    ...
    useEffect(() => {
        ...
        if (!gl) {
            ...
            markLoaded("light-pillar-webgl"); // Mark loaded even if failed, so we don't block
        }
    }, [markLoaded]);
    ...
    `;
        ...
        // Mouse interaction - listen on window so it works even behind other content
